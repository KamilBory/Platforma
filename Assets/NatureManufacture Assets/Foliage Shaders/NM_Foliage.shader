            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        Bindings_NMFoliageVSProIndirect_7b92be50f852bc440961517e733427f8 _NMFoliageVSProIndirect_5D24D019;
                        float3 _NMFoliageVSProIndirect_5D24D019_ObjectSpacePosition_1;
                        SG_NMFoliageVSProIndirect_7b92be50f852bc440961517e733427f8(IN.ObjectSpacePosition, _NMFoliageVSProIndirect_5D24D019, _NMFoliageVSProIndirect_5D24D019_ObjectSpacePosition_1);
                        float3 _CustomFunction_1F2F0AC0_vertex_3;
                        float3 _CustomFunction_1F2F0AC0_normal_4;
                        float4 _CustomFunction_1F2F0AC0_color_5;
                        CalculateWind_float(_NMFoliageVSProIndirect_5D24D019_ObjectSpacePosition_1, IN.ObjectSpaceNormal, IN.VertexColor, IN.TimeParameters.x, _CustomFunction_1F2F0AC0_vertex_3, _CustomFunction_1F2F0AC0_normal_4, _CustomFunction_1F2F0AC0_color_5);
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _Property_54FD2CED_Out_0 = _DISTANCEBLEND;
                        ...
                        float _Branch_53B5AA54_Out_3;
                        Unity_Branch_float(_Property_54FD2CED_Out_0, _Multiply_9E6704A_Out_2, _SampleTexture2D_3E7E8460_A_7, _Branch_53B5AA54_Out_3);
                        float _Property_6D561E3B_Out_0 = _AlphaCutoff;
                        surface.Alpha = _Branch_53B5AA54_Out_3;
        ...
        // We need isFontFace when using double sided
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    ...
                    {
                        SurfaceDescription surface = (SurfaceDescription)0;
                        float _Property_8238479B_Out_0 = _WINDCOLORMIX;
                        float4 _Property_3E4B16C8_Out_0 = _TilingOffset;
                        float _Split_7DC8027E_R_1 = _Property_3E4B16C8_Out_0[0];
                        float _Split_7DC8027E_G_2 = _Property_3E4B16C8_Out_0[1];
                        float _Split_7DC8027E_B_3 = _Property_3E4B16C8_Out_0[2];
                        ...
                        float _Split_BC7D5F21_R_1 = IN.AbsoluteWorldSpacePosition[0];
                        float _Split_BC7D5F21_G_2 = IN.AbsoluteWorldSpacePosition[1];
                        float _Split_BC7D5F21_B_3 = IN.AbsoluteWorldSpacePosition[2];
                        ...
                        float3 _Branch_7293F3B5_Out_3;
                        Unity_Branch_float3(_Property_8238479B_Out_0, _Multiply_AE688FC_Out_2, (_Multiply_67F895DE_Out_2.xyz), _Branch_7293F3B5_Out_3);
                        ...
                        Unity_Branch_float(_Property_54FD2CED_Out_0, _Multiply_9E6704A_Out_2, _SampleTexture2D_3E7E8460_A_7, _Branch_53B5AA54_Out_3);
                        float _Property_6D561E3B_Out_0 = _AlphaCutoff;
                        surface.Albedo = _Branch_7293F3B5_Out_3;
