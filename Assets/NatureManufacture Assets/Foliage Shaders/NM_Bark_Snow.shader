            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        Bindings_NMFoliageVSProIndirect_7b92be50f852bc440961517e733427f8 _NMFoliageVSProIndirect_16E05BCF;
                        float3 _NMFoliageVSProIndirect_16E05BCF_ObjectSpacePosition_1;
                        SG_NMFoliageVSProIndirect_7b92be50f852bc440961517e733427f8(IN.ObjectSpacePosition, _NMFoliageVSProIndirect_16E05BCF, _NMFoliageVSProIndirect_16E05BCF_ObjectSpacePosition_1);
                        float3 _CustomFunction_22CB6DD4_vertex_3;
                        float3 _CustomFunction_22CB6DD4_normal_4;
                        CalculateWind_float(_NMFoliageVSProIndirect_16E05BCF_ObjectSpacePosition_1, IN.ObjectSpaceNormal, IN.TimeParameters.x, _CustomFunction_22CB6DD4_vertex_3, _CustomFunction_22CB6DD4_normal_4);
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float3 _Transform_E1C5D1A9_Out_1 = normalize(mul(Transform_E1C5D1A9_transposeTangent, _Lerp_A6AC44DC_Out_3.xyz).xyz);
